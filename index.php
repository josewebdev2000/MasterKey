...
<main class="container-fluid bg-img-container bg-lock-img bg-img-bluish-hue flex-065 d-flex justify-content-center align-items-center">
  <div class="py-5 px-5 text-center m-5 hero gray-hero">
          ...
          <div class="col-lg-6 mx-auto">
            ...
            <p class="lead fsize-150">Don't you think it'd be great to safely store all your credentials in one place?</p>
            <p class="lead fsize-150">That place is <em>MasterKey</em></p>
            <p class="lead fsize-150 mb-4">What are you waiting for?</p>
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
              <a class="btn btn-primary btn-lg px-4 gap-3" href="register.php">Get Started</a>
            </div>
          </div>
    </div>
</main>
